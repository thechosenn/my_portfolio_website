...
import { ExternalLinks, CarouselButton, CarouselButtonDot, CarouselButtons, CarouselContainer, CarouselItem, CarouselItemImg, CarouselItemText, CarouselItemTitle, CarouselMobileScrollNode, TagList, TitleContent } from './ExperienceStyles';
          ...
          {ExperienceData.map((item, index) => (
            <CarouselMobileScrollNode
              ...
              <CarouselItem
                ...
                <TagList>
                  {item.tags.map((t, i) => {
                    return <ExternalLinks key={i}>{t}</ExternalLinks>;
                  })}
                </TagList>
              </CarouselItem>
            </CarouselMobileScrollNode>
